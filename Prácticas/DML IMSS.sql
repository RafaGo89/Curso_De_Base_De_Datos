...
insert into unidadesMedicas values ('UMF-78GDL', 'Clinica 78 IMSS-JALISCO', 'Guadalajara', 'Av. San Jacinto #578', '8006232323');
insert into unidadesMedicas values ('UMF-93TON', 'Clinica 93 IMSS-JALISCO', 'Tonala', 'Av. Tonaltecas #131', '8006812525');
insert into unidadesMedicas values ('UMF-52GDL', 'Clinica 52 IMSS-JALISCO', 'Guadalajara', 'Boulevar Marcelino Garcia Barragan #1596', '3339420000');
insert into unidadesMedicas values ('UMF-03GDL', 'Clinica 03 IMSS-JALISCO', 'Guadalajara', 'Belisario Dominguez #815', '3336188936');
insert into unidadesMedicas values ('UMF-92GDL', 'Clinica 92 IMSS-JALISCO', 'Guadalajara', 'Av.Gobernador Luis G.Curiel #4218', '3336704878');
insert into unidadesMedicas values ('UMF-54TLQ', 'Clinica 54 IMSS-JALISCO', 'Tlaquepaque', 'Vicente Guerrero #875', '3336804239');
...
insert into afiliados values ('54018885623', 'Javier', 'Hernandez', '1988/06/01', 'A+', 'Masculino', 'UMF-54TLQ', 'Matutino');
...
insert into afiliados values ('54221683941', 'Renata', 'Lopez', '2016/02/28', 'O-', 'Femenino', 'UMF-54TLQ', 'Vespertino');
